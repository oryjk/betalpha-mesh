...
| `betalpha-active-fund-star-rating` | Asking for the star rating / comprehensive assessment of an actively managed equity fund |
| `betalpha-etf-comprehensive-score` | Asking for the comprehensive assessment / star rating of an equity ETF |
| `betalpha-dividend-style-rotation` | Asking for core/debt-like/cyclical dividend buy-sell signals, or holdings of the dividend portfolios |

The last three are **research scenario skills**: their content is exported
verbatim from the Betalpha Mesh scenario catalog (generated in the admin
console, reviewed and published) and synced through the publish pipeline;
re-publishing this collection picks up scenario updates. Other scenarios can
be used online via the MCP `search_scenario_skills` /
`explain_scenario_skill` tools.
...
each question to one of the skills above.
...
- 0.2.0: add research scenario skills betalpha-active-fund-star-rating, betalpha-etf-comprehensive-score, betalpha-dividend-style-rotation
